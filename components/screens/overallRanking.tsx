      ...
      <div className="absolute bottom-[70px] right-[170px] z-20 h-[720px] w-[660px]">
        ...
        {teamsData?.slice(0, 8)?.map((team: any, index: any) => (
          <AnimatePresence key={index}>
            ...
            >
              <div
                className={`flex h-full w-full items-center justify-center ${index == 0 ? "bg-yellow-600 bg-opacity-30" : index == 1 ? "bg-white bg-opacity-30" : index == 2 ? "bg-orange-900 bg-opacity-30" : "bg-white bg-opacity-10"} text-2xl font-light backdrop-blur-xl`}
              >
